...
#    #metadados
#    class Meta:
#        ordering = ['-my_field_name', 'marca', 'descricao']
#        #verbose_name = 'marca'
#
#    #métodos
#    def get_absolute_url(self):
...
#
#wild_marcas = Marca.objects.filter(title__contains='wild')
#number_wild_marcas = Marca.objects.filter(title__contains='wild').count
#marcas_containing_descricao = Marca.objects.filter(descricao__name__icontains='fiction')
#
#